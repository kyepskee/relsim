use crate::vk::util::{SurfaceData, QueueFamilyIndices};
...
fn get_swapchain_support(physical_device: vk::PhysicalDevice, surface_data: &SurfaceData) -> SwapchainSupportDetails {
    unsafe {
